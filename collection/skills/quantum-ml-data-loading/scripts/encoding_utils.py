...
def amplitude_encoding_qiskit(
    vector: np.ndarray, validate: bool = True
) -> "QuantumCircuit":
    """
...
def angle_encoding_qiskit(data: np.ndarray, rotation: str = "RY") -> "QuantumCircuit":
    """
...
def calculate_encoding_metrics(target: np.ndarray, circuit: "QuantumCircuit") -> dict:
    """
