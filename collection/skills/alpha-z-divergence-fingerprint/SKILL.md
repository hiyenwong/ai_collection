...
### Step 1: Functional Connectome Construction

### Step 2: Alpha-Z Bures-Wasserstein Divergence Setup

### Step 3: Divergence Computation

### Step 4: Phenotypic Trait Extraction
...
**User:** I need to apply SKILL.md - Alpha-Z Divergence Brain Connectivity Fingerprint to my analysis.

**Agent:** I'll help you apply alpha-z-divergence-fingerprint. First, let me understand your specific use case...
...
**User:** What are the key considerations for alpha-z-divergence-fingerprint?
