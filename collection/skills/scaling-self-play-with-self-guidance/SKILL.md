...
description: "Self-Guided Self-Play (SGS) prevents conjecturer collapse in LLM self-play."
version: 1.0.0
created: 2026-05-04
tags:
  - llm
...
**arXiv ID:** 2604.20209 | **Code:** https://github.com/LukeBailey181/sgs

## Abstract

LLM self-play algorithms have no theoretical learning bounds,
but hit plateaus due to conjecturer collapse.
SGS introduces a Guide role to prevent degeneration,
enabling a 7B model after 200 rounds to surpass 671B pass@4
in formal theorem proving.

## Key Contributions

1. Identified conjecturer degradation in self-play: conjecturers learn to hack reward functions
2. Proposed SGS algorithm with three roles: Solver, Conjecturer, Guide
3. Demonstrated scaling laws: SGS sustains learning over 200+ rounds
4. Empirical result: 7B + SGS > 671B pass@4 on Lean4 theorem proving
...
3. **缩放训练**：长时间运行 Agent 军团，
   用 Eval 防止质量退化

## 触发词

scaling self-play, self-guidance, SGS, conjecturer collapse,
self-play LLM, theorem proving, REINFORCE1/2, guide reward,
solve rate reward, asymmetric self-play, scaling laws LLM
