...
**Date:** Wed, 18 Oct 2017 07:00:00 GMT
**Category:** OpenAI Research

## Activation Keywords

- sim-to-real transfer of robotic control with dynamics randomization
- openai sim-to-real-transfer-of-robotic-control-with-dynam
...
```python
# Research background
# See original paper: https://openai.com/index/sim-to-real-transfer-of-robotic-control-with-dynamics-randomization
```
...
**User:** I need to apply sim-to-real-transfer-of-robotic-control-with-dynam - Sim-to-real transfer of robotic control with dynamics randomization to my analysis.

**Agent:** I'll help you apply sim-to-real-transfer-of-robotic-control-with-dynam. First, let me understand your specific use case...
...
**User:** What are the key considerations for sim-to-real-transfer-of-robotic-control-with-dynam?
