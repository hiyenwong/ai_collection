...
```python
# Research background
# See original paper: https://openai.com/index/consistency-models
```
...
**User:** I need to apply consistency-models - Consistency Models to my analysis.

**Agent:** I'll help you apply consistency-models. First, let me understand your specific use case...
...
**User:** What are the key considerations for consistency-models?
