...
1. Identify the user's specific question or task related to Neat Nc Neat Guided Navigation
2. Gather relevant context from files or user input
3. Apply Neat Nc Neat Guided Navigation methodology to address the request
...
### Basic usage
```
User: "Help me with neat nc neat guided navigation"
→ Understand requirements → Apply methodology → Provide results
```

### Advanced usage
```
User: "I need detailed Neat Nc Neat Guided Navigation assistance"
