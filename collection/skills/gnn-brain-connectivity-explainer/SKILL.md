...
### Step 1: Construct Brain Graph from EEG

### Step 2: Build GNN Model

### Step 3: Train GNN on EEG Data

### Step 4: Apply GNNExplainer
...
**User:** I need to apply SKILL.md - GNN Brain Connectivity with GNNExplainer to my analysis.

**Agent:** I'll help you apply gnn-brain-connectivity-explainer. First, let me understand your specific use case...
...
**User:** What are the key considerations for gnn-brain-connectivity-explainer?
