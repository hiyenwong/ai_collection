...
**User:** I need to apply Self-Organization of Microcircuits in Neural Networks to my analysis.

**Agent:** I'll help you apply microcircuit-self-organization. First, let me understand your specific use case...

**Context:** Problem: Network Structure Formation

### Example 2: Advanced Scenario

**User:** Studying structure-dynamics relationships in neural networks
