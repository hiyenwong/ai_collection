...
**Date:** Fri, 25 May 2018 07:00:00 GMT
...
```python
# Research background
# See original paper: https://openai.com/index/gym-retro
```
...
**User:** I need to apply gym-retro - Gym Retro to my analysis.

**Agent:** I'll help you apply gym-retro. First, let me understand your specific use case...
...
**User:** What are the key considerations for gym-retro?
