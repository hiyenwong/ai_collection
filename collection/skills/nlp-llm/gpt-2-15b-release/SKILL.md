...
**Date:** Tue, 05 Nov 2019 08:00:00 GMT
**Category:** OpenAI Research

## Activation Keywords

- gpt-2: 1.5b release
- openai gpt-2-15b-release
- gpt 2 15b release
...
```python
# Research background
# See original paper: https://openai.com/index/gpt-2-1-5b-release
```
...
**User:** What are the key considerations for gpt-2-15b-release?
