...
### 6. Quantum Mpemba Symmetry Restoration in Fragmented Systems (NEW 2026-06-08)
- arXiv: 2606.06653 — Sreemayee Aditya, Sara Murciano, Xhek Turkeshi
- Higher-order symmetric quantum Mpemba effect: symmetry restoration is faster the more strongly it was initially broken
- Frozen vs active Krylov sector decomposition: fragmentation reshapes Mpemba into "frozen memory" + "active-fragment relaxation"
- Dual-timescale crossings: charge and dipole asymmetries restore on parametrically distinct timescales
- **Neuroscience link**: Frozen fragments ↔ persistent working memory; active fragments ↔ dynamic consolidation/forgetting
- See skill: `quantum-mpemba-symmetry-restoration`

### 7. Entanglement Distribution Noise Characterization (NEW 2026-06-08)
- arXiv: 2606.07043 — Kenneth Goodenough, Xiaonan Chen, Patrick Emonts
- Exact analytical noise distribution for GHZ state distribution in star networks under memory dephasing
- Factory vs piecemaker protocol comparison; analytical global cut-off optimization (no Monte Carlo needed)
- **Neuroscience link**: Stochastic link creation ↔ stochastic neural spike timing; memory dephasing during storage ↔ synaptic weight decay; cut-off optimization ↔ biological forgetting mechanisms
- See skill: `entanglement-distribution-star-networks`

### 8. Algebraic Quantum Neuroscience (KMS Formalism)
...
- **NEW (2026-06-08 hourly v3)**: Quantum Mpemba Effect in Fragmented Systems — arXiv 2606.06653, frozen vs active Krylov sector decomposition, dual-timescale symmetry restoration
- **NEW (2026-06-08 hourly v3)**: Entanglement Distribution Star Networks — arXiv 2606.07043, analytical noise distribution, factory vs piecemaker protocol comparison
- **NEW (2026-06-08)**: Quantum-metabolic limits on MEG information capacity — arXiv 2511.06401 derives fundamental 2.2 Mbit/s ceiling
- **NEW (2026-06-08)**: HQNN expressibility-trainability trade-off elimination — arXiv:2605.25768 shows full end-to-end hybrid training can completely eliminate the presumed trade-off
- **NEW (2026-06-08)**: Butterfly circuit O(log n) QNN training — arXiv:2606.03517 validates on IonQ 32-qubit hardware for clinical data
- **NEW (2026-06-08)**: Quantum subliminal learning security risk — arXiv:2605.29557 shows QNNs retain hidden-task signals unlike classical NNs

## References

See `references/neuroscience-quantum-2026-06-08.md` for session-specific scan results and methodology notes.
