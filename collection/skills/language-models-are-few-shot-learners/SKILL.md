...
**Date:** Thu, 28 May 2020 07:00:00 GMT
...
```python
# Research background
# See original paper: https://openai.com/index/language-models-are-few-shot-learners
```
...
**User:** I need to apply language-models-are-few-shot-learners - Language models are few-shot learners to my analysis.

**Agent:** I'll help you apply language-models-are-few-shot-learners. First, let me understand your specific use case...
...
**User:** What are the key considerations for language-models-are-few-shot-learners?
