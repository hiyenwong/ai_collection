...
class ArchitectureEvaluator:
    ...
    def _evaluate_accuracy(self, architecture: Dict) -> float:
        ...
        for i in range(len(features)):
            ...
            sample_circuit = self.supercircuit.build_circuit(architecture, sample_features)
    ...
    def _estimate_circuit_depth(self, architecture: Dict) -> int:
        ...
        # Total depth
        total_depth = embedding_depth + architecture['depth'] * (cnot_depth + variational_depth)
    ...
    def _preprocess_feature(self, feature: np.ndarray, architecture: Dict) -> np.ndarray:
        """
