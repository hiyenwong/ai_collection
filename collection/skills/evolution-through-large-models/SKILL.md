...
- openai evolution-through-large-models
- evolution through large models
...
```python
# Research background
# See original paper: https://openai.com/index/evolution-through-large-models
```
...
**User:** I need to apply evolution-through-large-models - Evolution through large models to my analysis.

**Agent:** I'll help you apply evolution-through-large-models. First, let me understand your specific use case...
...
**User:** What are the key considerations for evolution-through-large-models?
