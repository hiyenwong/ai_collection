...
### Basic Neural Encoding Evaluation Ground Truth usage
```
User: "Help me with neural encoding evaluation ground truth"
→ Understand requirements → Execute actions → Provide results
```

### Advanced usage
```
User: "I need detailed neural encoding evaluation ground truth assistance"
