...
**Date:** Wed, 21 Sep 2022 07:00:00 GMT
...
```python
# Research background
# See original paper: https://openai.com/index/whisper
```
...
**User:** I need to apply introducing-whisper - Introducing Whisper to my analysis.

**Agent:** I'll help you apply introducing-whisper. First, let me understand your specific use case...
...
**User:** What are the key considerations for introducing-whisper?
