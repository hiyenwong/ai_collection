...
### Paper: "Automating Detection and Root-Cause Analysis of Flaky Tests in Quantum Software" (2026-03-09)
- Quantum flaky tests: pass/fail inconsistently due to probabilistic outputs
- LLM classification achieves F1=0.9420 for detection, 0.9643 for root cause
- See quantum-program-analysis skill's `references/quantum-flaky-test-detection-2026-06-16.md` for extended methodology
