...
**Date:** Thu, 06 Apr 2017 07:00:00 GMT
...
```python
# Research background
# See original paper: https://openai.com/index/unsupervised-sentiment-neuron
```
...
**User:** I need to apply unsupervised-sentiment-neuron - Unsupervised sentiment neuron to my analysis.

**Agent:** I'll help you apply unsupervised-sentiment-neuron. First, let me understand your specific use case...
...
**User:** What are the key considerations for unsupervised-sentiment-neuron?
