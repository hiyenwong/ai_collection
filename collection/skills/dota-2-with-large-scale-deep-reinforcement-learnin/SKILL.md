...
**Date:** Fri, 13 Dec 2019 08:00:00 GMT
**Category:** OpenAI Research

## Activation Keywords

- dota 2 with large scale deep reinforcement learning
- openai dota-2-with-large-scale-deep-reinforcement-learnin
- dota 2 with large scale deep reinforcement learnin
...
```python
# Research background
# See original paper: https://openai.com/index/dota-2-with-large-scale-deep-reinforcement-learning
```
...
**User:** I need to apply dota-2-with-large-scale-deep-reinforcement-learnin - Dota 2 with large scale deep reinforcement learning to my analysis.

**Agent:** I'll help you apply dota-2-with-large-scale-deep-reinforcement-learnin. First, let me understand your specific use case...
...
**User:** What are the key considerations for dota-2-with-large-scale-deep-reinforcement-learnin?
