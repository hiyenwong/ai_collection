...
1. Identify the user's specific question or task related to Neural Critical Dynamics Theory
2. Gather relevant context from files or user input
3. Apply Neural Critical Dynamics Theory methodology to address the request
...
### Basic usage
```
User: "Help me with neural critical dynamics theory"
→ Understand requirements → Apply methodology → Provide results
```

### Advanced usage
```
User: "I need detailed Neural Critical Dynamics Theory assistance"
