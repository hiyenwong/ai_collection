...
def run_workflow():
    ...
    os.system("/Users/hiyenwong/.openclaw/workspace/scripts/kg_tool/target/release/kg_tool stats /Users/hiyenwong/.openclaw/workspace/kg.db")
    
    # Step 4: PageRank
    print("\n[Step 4] PageRank Analysis:")
    os.system("/Users/hiyenwong/.openclaw/workspace/scripts/kg_tool/target/release/kg_tool pagerank /Users/hiyenwong/.openclaw/workspace/kg.db")
