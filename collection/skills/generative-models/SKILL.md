...
**Date:** Thu, 16 Jun 2016 07:00:00 GMT
...
```python
# Research background
# See original paper: https://openai.com/index/generative-models
```
...
**User:** I need to apply generative-models - Generative models to my analysis.

**Agent:** I'll help you apply generative-models. First, let me understand your specific use case...
...
**User:** What are the key considerations for generative-models?
