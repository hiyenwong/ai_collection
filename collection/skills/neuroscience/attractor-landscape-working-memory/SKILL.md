...
### Step 1: Construct Large-Scale Brain Network

### Step 2: Build Computational Model

### Step 3: Compute Energy Landscape

### Step 4: Quantify Attractor Properties

### Step 5: Analyze Transition Paths

## Examples

### Example 1: Basic Application

**User:** I need to apply SKILL.md - Attractor Landscape Working Memory to my analysis.

**Agent:** I'll help you apply attractor-landscape-working-memory. First, let me understand your specific use case...

**Context:** Energy minima = stable brain states
