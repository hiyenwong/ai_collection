...
### Pattern 4: NLQC Task Equivalence Analysis (arXiv: 2606.26354)

For quantum position-verification and non-local computation protocols:
- NLQC tasks connected by bidirectional reductions share the same asymptotic entanglement cost scaling
- Redirect quantum system (classical control) implies controlled measurements in arbitrary bases, controlled Clifford unitaries, and controlled $U = C_1 D C_0$ (D diagonal)
- Security analysis of the simplest equivalent task extends to all tasks in the reduction class
- **Key insight**: When designing or analyzing a position-verification scheme, find the minimal NLQC task it reduces to — that task determines the entanglement cost lower bound
- **Gate teleportation** and **measurement-based QC** are the primary reduction tools

## Related Skills

- **quantum-nlqc-reductions** — NLQC task reduction methodology for position-verification security analysis
