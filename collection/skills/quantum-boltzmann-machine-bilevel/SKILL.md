...
- **`spectral-born-machines`** (2607.06675) — Quantum generative models using group Fourier analysis with QFT-based spectral inductive bias. Classically trainable via MMD with graph spectral kernels. Scalable to 190 qubits, 1M+ parameters. Over-parameterized models immune to overfitting in data-scarce regimes. Complementary to QBMs: SBMs exploit spectral structure for discrete data, QBMs use energy-based learning for general distributions.
