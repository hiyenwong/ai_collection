...
**Source**: arXiv:2605.17771 (May 2026) — Balakrishna et al. "Multi-Class Neurological Disorder Prediction with Tensor Network Feature Engineering". Evaluated on 55,160 images across 8 diagnostic categories using 5-fold nested stratified cross-validation. Both higher and lower PARAFAC rank configurations achieve strong performance, demonstrating robustness to tensor network expressivity.

## PARAFAC CP Decomposition Approach

The paper uses PARAFAC CP (Canonical Polyadic) tensor decomposition, which is mathematically inspired by quantum neural network architectures but implemented entirely classically:
