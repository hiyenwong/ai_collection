...
1. Identify the user's specific question or task related to Context Selective Multimodal Memory
2. Gather relevant context from files or user input
3. Apply Context Selective Multimodal Memory methodology to address the request
...
### Basic usage
```
User: "Help me with context selective multimodal memory"
→ Understand requirements → Apply methodology → Provide results
```

### Advanced usage
```
User: "I need detailed Context Selective Multimodal Memory assistance"
