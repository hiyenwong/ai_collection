...
**User:** I need to apply naplib-python Neural Acoustic Processing to my analysis.

**Agent:** I'll help you apply naplib-neural-acoustic-processing. First, let me understand your specific use case...

**Context:** 听觉神经科学数据处理面临的问题：
- 数据格式不统一
- 试验持续时间不同
- 多模态刺激处理复杂
- 缺乏标准化分析工具
