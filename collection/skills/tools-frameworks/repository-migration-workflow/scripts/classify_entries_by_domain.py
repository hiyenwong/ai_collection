...
def main(
    base_dir: str, domains_config: str = None, output: str = "migration_plan.json"
):
    ...
    for entry_name in entries:
        ...
        migration_plan.append({"name": entry_name, "domain": domain})
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Classify repository entries by domain"
    )
    ...
    parser.add_argument(
        "--output", default="migration_plan.json", help="Output migration plan file"
    )
