...
**Date:** Tue, 03 Dec 2019 08:00:00 GMT
...
```python
# Research background
# See original paper: https://openai.com/index/procgen-benchmark
```
...
**User:** I need to apply procgen-benchmark - Procgen Benchmark to my analysis.

**Agent:** I'll help you apply procgen-benchmark. First, let me understand your specific use case...
...
**User:** What are the key considerations for procgen-benchmark?
