...
### Basic Meta Learning In Context Enables Training Free Cross Subject usage
```
User: "Help me with meta learning in context enables training free cross subject"
→ Understand requirements → Execute actions → Provide results
```

### Advanced usage
```
User: "I need detailed meta learning in context enables training free cross subject assistance"
