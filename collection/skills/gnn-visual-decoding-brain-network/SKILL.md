...
### Basic Gnn Visual Decoding Brain Network usage
```
User: "Help me with gnn visual decoding brain network"
→ Understand requirements → Execute actions → Provide results
```

### Advanced usage
```
User: "I need detailed gnn visual decoding brain network assistance"
