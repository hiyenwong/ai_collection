...
- "hybrid-temporal-spike-coding"
- "hybrid temporal spike coding"
- "use hybrid temporal spike coding"
- "hybrid temporal spike coding help"
- "hybrid temporal spike coding analysis"
...
1. Identify the user's specific question or task related to Hybrid Temporal Spike Coding
2. Gather relevant context from files or user input
3. Apply Hybrid Temporal Spike Coding methodology to address the request
...
### Basic usage
```
User: "Help me with hybrid temporal spike coding"
→ Understand requirements → Apply methodology → Provide results
```

### Advanced usage
```
User: "I need detailed Hybrid Temporal Spike Coding assistance"
