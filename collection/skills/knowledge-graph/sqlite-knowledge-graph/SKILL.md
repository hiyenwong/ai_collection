...
**User:** I need to apply SQLite Knowledge Graph to my analysis.

**Agent:** I'll help you apply sqlite-knowledge-graph. First, let me understand your specific use case...

**Context:** Apply the methodology

### Example 2: Advanced Scenario

**User:** Building knowledge graphs
