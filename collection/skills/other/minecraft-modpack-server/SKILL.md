...
- "minecraft modpack server"
- "use minecraft modpack server"
- "minecraft modpack server help"
- "minecraft modpack server tool"
...
### Basic Minecraft Modpack Server usage
```
User: "Help me with minecraft modpack server"
→ Understand requirements → Execute actions → Provide results
```

### Advanced usage
```
User: "I need detailed minecraft modpack server assistance"
