...
- **Developer expertise gap**: Limited pool of developers with quantum + SE expertise makes automation essential for productivity

## Automated QSE/QAI Workflow (2026-06-16 addition)

Beyond manual architecture design, automated approaches to Quantum Software Engineering (QSE) and Quantum AI (QAI) are critical for scaling:
- **Automated deployment decision**: Algorithms that decide what runs on quantum hardware vs classical hardware
- **Platform selection automation**: Selecting optimal quantum platform based on application requirements
- **Automated testing pipelines**: CI/CD with quantum simulators and noise-aware compilation
- **AI-assisted code generation**: LLM-powered quantum program synthesis and linting
- **Systematic literature**: See "Automated Quantum Software and AI Engineering" (arXiv: 2604.19970) for comprehensive survey
