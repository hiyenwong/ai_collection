---
name: can-induced-emotion-bias-llm-behaviors-in-sequenti
description: "Can Induced Emotion Bias LLM Behaviors in Sequential Decision Making? - As Large Language Models (LLMs) are increasingly deployed as autonomous agents in high-stakes domains, understanding contextual factors that may modul..."
version: 1.0.0
author: Minh Khoi Ho, Zihao Zhu, Runchuan Zhu et al.
arxiv_id: 2607.12631
created: 2026-07-14
category: other
tags: [cs.CL, cs.AI]
activation_keywords: [induced, emotion, bias, behaviors, sequential, decision, making, large, language, models]
---
...
induced, emotion, bias, behaviors, sequential, decision, making, large, language, models
