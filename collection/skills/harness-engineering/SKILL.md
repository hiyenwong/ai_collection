...
### Step 1: AGENTS.md → ~100 lines

### Step 2: Structure docs/ directory

### Step 3: Add custom linters

### Step 4: Implement agent-to-agent review

### Step 5: Add doc-gardening agent

## Examples

### Example 1: Basic Application

**User:** I need to apply Harness Engineering: Agent-First Development to my analysis.

**Agent:** I'll help you apply harness-engineering. First, let me understand your specific use case...
