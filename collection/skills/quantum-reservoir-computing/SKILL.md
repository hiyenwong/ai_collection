...
**Usage**: Nonlinear quantum functional approximation, temporal processing of quantum state sequences, experimental assessment with measurement back-action. Particularly advantageous in partial information regime (single-axis measurements). See `ai_collection/hybrid-quantum-classical-reservoirs` skill (arXiv:2606.21327).
...
- hybrid-quantum-classical-reservoirs — Hybrid QRC+ESN for nonlinear functionals (arXiv:2606.21327)
- non-markovian-kerr-feedback-qrc — Kerr nonlinear feedback superiority in CV-QRC (arXiv:2606.06689)
