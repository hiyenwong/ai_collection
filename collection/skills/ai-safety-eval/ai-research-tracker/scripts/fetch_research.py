...
OBSIDIAN_PATH = os.environ.get(
    "OBSIDIAN_VAULT", "/Users/hiyenwong/obsdian/Documents/OpenAI Research"
)
...
def main():
    ...
    if not content:
        ...
        print(
            "2. Verify proxy: curl --proxy http://127.0.0.1:7890 https://httpbin.org/ip"
        )
        print(
            '3. Test jina.ai: curl -sL "https://r.jina.ai/http://openai.com/research"'
        )
        sys.exit(1)
