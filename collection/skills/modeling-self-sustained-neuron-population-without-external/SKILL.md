...
### Basic Modeling Self Sustained Neuron Population Without External usage
```
User: "Help me with modeling self sustained neuron population without external"
→ Understand requirements → Execute actions → Provide results
```

### Advanced usage
```
User: "I need detailed modeling self sustained neuron population without external assistance"
