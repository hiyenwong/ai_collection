...
```bash
gemini "Use geneticist to {task_description}"
```
...
# The agent is available at collection/agents/geneticist/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/geneticist/AGENT.md" -- "{task_description}"
```
