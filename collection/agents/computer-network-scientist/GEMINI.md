...
- **Agent Name**: computer-network-scientist
...
```bash
gemini "Use computer-network-scientist to {task_description}"
```
...
# The agent is available at collection/agents/computer-network-scientist/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/computer-network-scientist/AGENT.md" -- "{task_description}"
```
