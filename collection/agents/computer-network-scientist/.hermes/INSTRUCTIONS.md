...
/path/to/ai_collection/collection/agents/computer-network-scientist/

# Add to Hermes config:
{
  "agents": {
    "computer-network-scientist": {
      "system_prompt": "Read /path/to/ai_collection/collection/agents/computer-network-scientist/AGENT.md"
    }
  }
}
```
