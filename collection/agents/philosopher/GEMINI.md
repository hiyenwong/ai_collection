...
```bash
gemini "Use philosopher to {task_description}"
```
...
# The agent is available at collection/agents/philosopher/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/philosopher/AGENT.md" -- "{task_description}"
```
