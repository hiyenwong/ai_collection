...
/path/to/ai_collection/collection/agents/population-dynamics-scientist/

# Add to Hermes config:
{
  "agents": {
    "population-dynamics-scientist": {
      "system_prompt": "Read /path/to/ai_collection/collection/agents/population-dynamics-scientist/AGENT.md"
    }
  }
}
```
