...
- **Agent Name**: population-dynamics-scientist
...
```bash
gemini "Use population-dynamics-scientist to {task_description}"
```
...
# The agent is available at collection/agents/population-dynamics-scientist/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/population-dynamics-scientist/AGENT.md" -- "{task_description}"
```
