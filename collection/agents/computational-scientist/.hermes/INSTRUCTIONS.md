...
/path/to/ai_collection/collection/agents/computational-scientist/

# Add to Hermes config:
{
  "agents": {
    "computational-scientist": {
      "system_prompt": "Read /path/to/ai_collection/collection/agents/computational-scientist/AGENT.md"
    }
  }
}
```
