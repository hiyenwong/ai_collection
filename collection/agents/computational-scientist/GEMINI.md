...
- **Agent Name**: computational-scientist
...
```bash
gemini "Use computational-scientist to {task_description}"
```
...
# The agent is available at collection/agents/computational-scientist/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/computational-scientist/AGENT.md" -- "{task_description}"
```
