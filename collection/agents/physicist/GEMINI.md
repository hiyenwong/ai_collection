...
```bash
gemini "Use physicist to {task_description}"
```
...
# The agent is available at collection/agents/physicist/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/physicist/AGENT.md" -- "{task_description}"
```
