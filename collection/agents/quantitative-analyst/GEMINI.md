...
```bash
gemini "Use quantitative-analyst to {task_description}"
```
...
# The agent is available at collection/agents/quantitative-analyst/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/quantitative-analyst/AGENT.md" -- "{task_description}"
```
