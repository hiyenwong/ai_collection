...
```bash
gemini "Use linguist to {task_description}"
```
...
# The agent is available at collection/agents/linguist/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/linguist/AGENT.md" -- "{task_description}"
```
