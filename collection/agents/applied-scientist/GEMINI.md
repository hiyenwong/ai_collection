...
```bash
gemini "Use applied-scientist to {task_description}"
```
...
# The agent is available at collection/agents/applied-scientist/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/applied-scientist/AGENT.md" -- "{task_description}"
```
