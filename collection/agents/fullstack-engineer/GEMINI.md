...
```bash
gemini "Use fullstack-engineer to {task_description}"
```
...
# The agent is available at collection/agents/fullstack-engineer/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/fullstack-engineer/AGENT.md" -- "{task_description}"
```
