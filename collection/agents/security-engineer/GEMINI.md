...
```bash
gemini "Use security-engineer to {task_description}"
```
...
# The agent is available at collection/agents/security-engineer/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/security-engineer/AGENT.md" -- "{task_description}"
```
