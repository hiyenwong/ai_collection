...
```bash
gemini "Use tech-researcher to {task_description}"
```
...
# The agent is available at collection/agents/tech-researcher/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/tech-researcher/AGENT.md" -- "{task_description}"
```
