...
```bash
gemini "Use ml-engineer to {task_description}"
```
...
# The agent is available at collection/agents/ml-engineer/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/ml-engineer/AGENT.md" -- "{task_description}"
```
