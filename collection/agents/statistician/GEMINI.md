...
```bash
gemini "Use statistician to {task_description}"
```
...
# The agent is available at collection/agents/statistician/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/statistician/AGENT.md" -- "{task_description}"
```
