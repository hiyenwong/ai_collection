...
```bash
gemini "Use logician to {task_description}"
```
...
# The agent is available at collection/agents/logician/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/logician/AGENT.md" -- "{task_description}"
```
