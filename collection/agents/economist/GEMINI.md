...
```bash
gemini "Use economist to {task_description}"
```
...
# The agent is available at collection/agents/economist/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/economist/AGENT.md" -- "{task_description}"
```
