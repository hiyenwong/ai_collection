...
```bash
gemini "Use data-engineer to {task_description}"
```
...
# The agent is available at collection/agents/data-engineer/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/data-engineer/AGENT.md" -- "{task_description}"
```
