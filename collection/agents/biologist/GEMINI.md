...
```bash
gemini "Use biologist to {task_description}"
```
...
# The agent is available at collection/agents/biologist/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/biologist/AGENT.md" -- "{task_description}"
```
