...
```bash
gemini "Use research-agent to {task_description}"
```
...
# The agent is available at collection/agents/research-agent/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/research-agent/AGENT.md" -- "{task_description}"
```
