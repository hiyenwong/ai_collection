...
```bash
gemini "Use algorithm-engineer to {task_description}"
```
...
# The agent is available at collection/agents/algorithm-engineer/
```
...
```bash
gemini --system-prompt "Read /path/to/ai_collection/collection/agents/algorithm-engineer/AGENT.md" -- "{task_description}"
```
