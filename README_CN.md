...
<<<<<<< Updated upstream
[![Skills](https://img.shields.io/badge/Skills-7074-purple.svg)](./collection/skills/)
=======
[![Skills](https://img.shields.io/badge/Skills-1880-purple.svg)](./collection/skills/)
>>>>>>> Stashed changes
...
[查看全部 7074 个技能 →](./collection/skills/)
...
每个编程技能现在包含**自动版本检测**。当您的安装版本与文档版本不同时，会收到更新建议和新功能亮点。
...
建议执行: npm update -g @anthropic-ai/claude-code
