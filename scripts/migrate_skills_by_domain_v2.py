...
DOMAIN_KEYWORDS = {
    "neuroscience": [
        "brain", "neural", "neuron", "eeg", "fmri", "cognitive", "spiking", "snn",
        "neuroplastic", "synaptic", "hippocampal", "cortex", "bci", "neuroscience"
    ],
    "quantum": [
        "quantum", "qubit", "qaoa", "vqe", "qml", "qnn", "qkd", "qec", "qrc",
        "entanglement", "superconducting", "photonic", "bosonic", "gkp"
    ],
    "ai-ml": [
        "transformer", "llm", "moe", "attention", "reinforcement", "gradient",
        "training", "learning", "agent", "agentic", "model", "deep", "network",
        "optimization", "rnn", "cnn", "distillation", "finetune", "prompt"
    ],
    "systems-engineering": [
        "distributed", "control", "mpc", "cyber", "physical", "cps", "embedded",
        "realtime", "fault", "tolerant", "resilience", "security", "protocol"
    ],
    "math-statistics": [
        "mathematic", "statistical", "probability", "bayesian", "inference",
        "tensor", "matrix", "algebra", "geometry", "topology", "calculus",
        "differential", "equation", "optimization", "convex"
    ],
    "medical": [
        "medical", "health", "clinical", "diagnosis", "drug", "therapy",
        "imaging", "biomarker", "patient", "hospital", "disease"
    ],
    "finance": [
        "finance", "portfolio", "stock", "trading", "market", "risk", "option",
        "pricing", "investment", "quantitative", "economic"
    ],
    "control-systems": [
        "control", "mpc", "feedback", "stability", "dynamics", "oscillator",
        "synchronization", "phase", "kuramoto", "robust", "adaptive"
    ],
    "tools-frameworks": [
        "docker", "git", "github", "chrome", "electron", "react", "frontend",
        "obsidian", "skill", "plugin", "mcp", "cli", "api"
    ]
}
