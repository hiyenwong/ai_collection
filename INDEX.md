...
- [[bilinear-gating-motor-primitives-dendritic-computation]] - Burst fraction编码目标信息，树突巧合检测实现双线性门控G(g)·Y(s)，RL Agent零样本泛化到新目标 (arXiv: 2606.10891)
  ...
  - RL应用：零样本泛化到新目标，快速在线适应
  - **Activation**: bilinear gating, motor primitives, dendritic computation, burst fraction, goal-directed adaptation, coincidence detection

### Hyperbolic Neural Population Geometry Benefits Computation
- [[hyperbolic-neural-population-geometry-computation]] - 海马体神经群体活动呈双曲几何，Modern Hopfield Network计算MMSE估计器，双曲联想记忆容量显著大于欧几里得模型 (arXiv: 2606.10238, ICML 2026)
  - Place field tuning curves统计学诱导双曲几何
  - Hopfield Network = MMSE estimator (贝叶斯后验均值)
  - 双曲联想记忆容量 > 欧几里得Hopfield Network
  - 空间认知：动物编码空间信息为潜在双曲认知地图
  - **Activation**: hyperbolic geometry, neural population, hippocampus, associative memory, MMSE estimator, cognitive map, ICML 2026
